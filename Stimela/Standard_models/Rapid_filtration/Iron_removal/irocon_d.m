function PInfo=irocon_d
% PInfo=irocon_d
%   function for definition of the irocon_d parameters
%
% Stimela, 2004
...
PInfo = st_addPInfo(PInfo,'Surf',  '0',    0,     +inf, 'm²',    'Reactor surface area:');
%PInfo = st_addPInfo(PInfo,'Lwater',  '0',    -inf,     +inf, 'm',    'Water level above the filter bed:');
%PInfo = st_addPInfo(PInfo,'Lbed',  '0',    -inf,     +inf, 'm',    'Reactor length:');
...
PInfo = st_addPInfo(PInfo,'Kfe',  '0',    0,     +inf, '1/s',    'Transformation coefficient iron II:');
