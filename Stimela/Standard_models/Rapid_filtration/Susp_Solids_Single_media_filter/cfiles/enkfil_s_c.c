/* enkfil_s_c.c template to be used for Stimela models in combination 
   with the enkfil_s_code.c file
 */
#define S_FUNCTION_NAME  enkfil_s_c
...
extern int enkfil_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int enkfil_Update(real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int enkfil_Outputs(real_T *sysWQ, real_T *sysEM, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
 ...
 */
 ...
 static char StimelaErrorMessage[512];

 void StimelaSetErrorMessage(char * MyErrorMessage)
 {
      strncpy(StimelaErrorMessage,MyErrorMessage,511);
      StimelaErrorMessage[511]=0;
 }
...
int CheckPar(SimStruct *S)
{
  ...
  {
        ssSetErrorStatus(S,"Missing B.WaterIn in Block parameters");
        return 1;
  }

  if (mxGetField(ssGetSFcnParam(S, 0),0,"WaterOut")==NULL)
  {
        ssSetErrorStatus(S,"Missing B.WaterOut in Block parameters");
        return 1;
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if (enkfil_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#undef MDL_UPDATE  /* Change to #undef to remove function */
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    if (enkfil_Update(t,xC,xD,uWQ,uES,
                      ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3)))
    {
      ssSetErrorStatus(S,StimelaErrorMessage);
    }
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    for (i=0; i<(int)B(S,"CStates"); i++)
    {
	 ...
	 if (enkfil_Derivatives(sys,t,xC,xD,uWQ,uES,
                          ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3)))
   {
     ssSetErrorStatus(S,StimelaErrorMessage);
   }
