function [B,x0,U] = bacwa1_i(bacwa1_file)
% [B,x0,U] = bacwa1_i(bacwa1_file)
%   initialisation of model bacwa1
%   B   Model size
...
x0=[P.Tst*3600-P.TL*3600];              % collumn vector with the same length as B_CStates + 
