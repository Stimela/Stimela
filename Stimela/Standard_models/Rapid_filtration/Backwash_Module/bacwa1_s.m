function [sys,x0,str,ts] = bacwa1_s(t,x,u,flag,B,x0,U,P),
%  [sys,x0,str,ts] = bacwa1_s(t,x,u,flag,B,x0,U,P),
%    Stimela S-Function
%
% t = time
...
% u = input vector
%
% P =  proces parameters, filled with bacwa1_p.m and defined in bacwa1_d.m
% B =  Model size, filled with bacwa1_i.m,
% x0 = initial state, filled with bacwa1_i.m,
