/* biofil_s_c.c template to be used for Stimela models in combination 
   with the biofil_s_code.c file
 */
#define S_FUNCTION_NAME  biofil_s_c
...
extern void biofil_Derivatives(real_T *sysC, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void biofil_Update(real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void biofil_Outputs(real_T *sysWQ, real_T *sysEM, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
...
int CheckPar(SimStruct *S)
{
  ...
  {
        ssSetErrorStatus(S,"Missing B.WaterIn in Block parameters. Adjust biofil_i.m!");
        return 1;
  }

  if (mxGetField(ssGetSFcnParam(S, 0),0,"WaterOut")==NULL)
  {
        ssSetErrorStatus(S,"Missing B.WaterOut in Block parameters. Adjust biofil_i.m!");
        return 1;
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    biofil_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    biofil_Derivatives(sys,t,xC,xD,uWQ,uES,
                          ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3));
