...
#define S_FUNCTION_NAME  plaatb_s_c
...
extern void plaatb_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void plaatb_Update(real_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void plaatb_Outputs(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
static double pH_oud;
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    for (i=0;i<U(S,"Number");i++)
	{
	  sys[i] = u[i];
	}
    for (i=U(S,"Number");i<U(S,"Number")+B(S,"Measurements");i++)
	{
	  sys[i] = 0.0;
	}

    plaatb_Outputs(sys,t,xC,xD,u,
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
	...
	plaatb_Derivatives(sys,t,xC,xD,u,
      ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3));
