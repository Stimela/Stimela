...
// you can use the following function to determine CaCO3 Crystalization potential (included)
//   dCaCO3 = CE_CCCP(Ca,M,P,K1,K2,Kw,Ks,f)
...
// © 2004, Kim van Schagen, Luuk Rietveld
...
double H3O,t0;
 H3O = pow(10,(3-pH))/f;
K1=K1/pow(f,2);K2=K2/pow(f,4);Kw=Kw/pow(f,2);
      t0 = -(-K2*HCO3*K1+HCO3*H3O*H3O-Kw*K1+H3O*H3O*K1)/H3O/K1;
return t0;
}
...
double H3O,t0;
 H3O = pow(10,(3-pH))/f;
K1=K1/pow(f,2);K2=K2/pow(f,4);Kw=Kw/pow(f,2);
      t0 = -H3O*(P*H3O-Kw+H3O*H3O)/(-K1*K2+H3O*H3O);
return t0;
}
...
double H3O,t0;
 H3O = pow(10,(3-pH))/f;
K1=K1/pow(f,2);K2=K2/pow(f,4);Kw=Kw/pow(f,2);
      t0 = -K1*(P*H3O-Kw+H3O*H3O)/(-K1*K2+H3O*H3O);
return t0;
}
...
double H3O,t0;
 H3O = pow(10,(3-pH))/f;
K1=K1/pow(f,2);K2=K2/pow(f,4);Kw=Kw/pow(f,2);
      t0 = -K2*K1*(P*H3O-Kw+H3O*H3O)/(-K1*K2+H3O*H3O)/H3O;
return t0;
}
...
double H3O,t0;
 H3O = pow(10,(3-pH))/f;
K1=K1/pow(f,2);K2=K2/pow(f,4);Kw=Kw/pow(f,2);
      t0 = -(2.0*P*H3O*K1*K2-Kw*K1*K2+K1*K2*H3O*H3O+H3O*H3O*K1*P-Kw*K1*H3O+H3O*H3O*H3O*K1-H3O*H3O*Kw+H3O*H3O*H3O*H3O)/(-K1*K2+H3O*H3O)/H3O;
return t0;
}
...
double CE_CCCP(double Ca, double M, double P, double K1, double K2, double Kw, double Ks, double f0, double IB0)
{
double pH0;
pH0 = CE_MP_pH(M,P,K1,K2,Kw,f0,7);

return finddCa(0,pH0,Ca,M,P,K1,K2,Kw,Ks,f0,IB0);
}
