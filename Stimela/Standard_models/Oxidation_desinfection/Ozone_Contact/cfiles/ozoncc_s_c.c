/* ozoncc_s_c.c template to be used for Stimela models in combination 
   with the ozoncc_s_code.c file
 */
#define S_FUNCTION_NAME  ozoncc_s_c
...
extern int ozoncc_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int ozoncc_Update(real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int ozoncc_Outputs(real_T *sysWQ, real_T *sysEM, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if (ozoncc_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#undef MDL_UPDATE  /* Change to #undef to remove function */
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    if (ozoncc_Update(t,xC,xD,uWQ,uES,
                      ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3)))
    {
  //    ssSetErrorStatus(S,StimelaErrorMessage);
    }
