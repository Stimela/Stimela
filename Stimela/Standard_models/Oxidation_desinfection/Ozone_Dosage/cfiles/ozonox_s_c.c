/* ozonox_s_c.c template to be used for Stimela models in combination 
   with the ozonox_s_code.c file
 */
#define S_FUNCTION_NAME  ozonox_s_c
...
extern int ozonox_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int ozonox_Update(real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern int ozonox_Outputs(real_T *sysWQ, real_T *sysEM, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if (ozonox_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#undef MDL_UPDATE  /* Change to #undef to remove function */
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    if (ozonox_Update(t,xC,xD,uWQ,uES,
                      ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3)))
    {
  //    ssSetErrorStatus(S,StimelaErrorMessage);
    }
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    for (i=0; i<(int)B(S,"CStates"); i++)
    {
	 ...
	 if (ozonox_Derivatives(sys,t,xC,xD,uWQ,uES,
                          ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3)))
   {
//     ssSetErrorStatus(S,StimelaErrorMessage);
   }
