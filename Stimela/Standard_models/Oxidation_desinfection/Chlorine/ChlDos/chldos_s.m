function [sys,x0,str,ts] = chldos_s(t,x,u,flag,B,x0,U,P),
%  [sys,x0,str,ts] = chldos_s(t,x,u,flag,B,x0,U,P),
%    Stimela S-Function
%
% t = time
...
% u = input vector
%
% P =  proces parameters, filled with chldos_p.m and defined in chldos_d.m
% B =  Model size, filled with chldos_i.m,
% x0 = initial state, filled with chldos_i.m,
