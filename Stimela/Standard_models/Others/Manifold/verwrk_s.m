function [sys,x0,str,ts] = verwrk_s(t,x,u,flag,B,x0,U,P),
%  [sys,x0,str,ts] = verwrk_s(t,x,u,flag,B,x0,U,P),
%    Stimela S-Function
%
% t = time
...
% u = input vector
%
% P =  proces parameters, filled with verwrk_p.m and defined in verwrk_d.m
% B =  Model size, filled with verwrk_i.m,
% x0 = initial state, filled with verwrk_i.m,
