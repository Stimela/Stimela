...
void block0_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
...
extern void block0_Update(creal_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin)
{
  //flag =2 vullen xD;
...
void block0_Outputs(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin)
{
  //flag=3
  int i;
