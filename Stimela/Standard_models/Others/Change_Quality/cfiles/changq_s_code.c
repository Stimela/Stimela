...
void changq_Derivatives(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
...
extern void changq_Update(creal_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin)
{
  //flag =2 vullen xD;
...
void changq_Outputs(real_T *sys, real_T t, real_T *xC, real_T *xD, real_T *u,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin)
{
  //flag=3
  int i;
