/* wsgetq_s_c.c template to be used for Stimela models in combination 
   with the wsgetq_s_code.c file
 */
#define S_FUNCTION_NAME  wsgetq_s_c
...
extern void wsgetq_Derivatives(real_T *sysC, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
