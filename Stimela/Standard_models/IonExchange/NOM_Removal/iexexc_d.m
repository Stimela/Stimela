function PInfo=iexfil_d
% PInfo=iexfil_d
%   function for definition of the iexfil_d parameters
%
% Stimela, 2004
...
PInfo = st_addPInfo(PInfo,'rhoK',  '500',    -inf,     +inf, 'kg/m³',    'Massdensity of the resin:');
...
PInfo = st_addPInfo(PInfo,'DOCna',  '0.1',    -inf,     +inf, 'mg/l',    'Non exchanged DOC:');
