/* block0_s_c.c template to be used for Stimela models in combination 
   with the block0_s_code.c file
 */
#define S_FUNCTION_NAME  block0_s_c
...
extern void block0_Derivatives(real_T *sysC, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
...
int CheckPar(SimStruct *S)
{
  ...
  {
        ssSetErrorStatus(S,"Missing B.WaterIn in Block parameters. Adjust block0_i.m!");
        return 1;
  }

  if (mxGetField(ssGetSFcnParam(S, 0),0,"WaterOut")==NULL)
  {
        ssSetErrorStatus(S,"Missing B.WaterOut in Block parameters. Adjust block0_i.m!");
        return 1;
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    block0_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    block0_Derivatives(sys,t,xC,xD,uWQ,uES,
                          ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3));
