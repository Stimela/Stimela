/* coagul_s_c.c template to be used for Stimela models in combination 
   with the coagul_s_code.c file
 */
#define S_FUNCTION_NAME  coagul_s_c
...
extern void coagul_Derivatives(real_T *sysC, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void coagul_Update(real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);
extern void coagul_Outputs(real_T *sysWQ, real_T *sysEM, real_T t, real_T *xC, real_T *xD, real_T *uWQ, real_T *uES,
                         mxArray *Bin, mxArray *Uin, mxArray *Pin);

//voor doorgeven fouten!
SimStruct *SS;
 ...
 */
 ...
 {
      ssSetErrorStatus(SS,MyErrorMessage);
 }
...
int CheckPar(SimStruct *S)
{
  ...
  {
        ssSetErrorStatus(S,"Missing B.WaterIn in Block parameters. Adjust coagul_i.m!");
        return 1;
  }

  if (mxGetField(ssGetSFcnParam(S, 0),0,"WaterOut")==NULL)
  {
        ssSetErrorStatus(S,"Missing B.WaterOut in Block parameters. Adjust coagul_i.m!");
        return 1;
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    coagul_Outputs(sysWQ,sysEM,t,xC,xD,uWQ,uES,
...
#define MDL_DERIVATIVES  /* Change to #undef to remove function */
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    coagul_Derivatives(sys,t,xC,xD,uWQ,uES,
                          ssGetSFcnParam(S, 0),ssGetSFcnParam(S, 2),ssGetSFcnParam(S, 3));
